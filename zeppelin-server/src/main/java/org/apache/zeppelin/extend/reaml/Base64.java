...
public class Base64 {
   ...
   * anywhere along their length by specifying <var>srcOffset</var> and <var>destOffset</var>. This
   * method does not check to make sure your arrays are large enough to accomodate
   ...
   * <var>numSigBytes</var>. </p> <p> This is the lowest level of the encoding methods with all
   ...
   * encoding. <p> This is the lowest level of the decoding methods with all possible parameters.
   * </p>
   *
   * @param source the array to convert
   * @param srcOffset the index where conversion begins
