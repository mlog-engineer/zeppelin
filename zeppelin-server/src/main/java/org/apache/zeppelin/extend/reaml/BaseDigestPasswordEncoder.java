 ...
 */
public class BaseDigestPasswordEncoder {
  // ~ Instance fields
  ...
  /**
   * The encoded password is normally returned as Hex (32 char) version of the hash bytes. Setting
   * this property to true will cause the encoded pass to be returned as Base64 text, which will
   * consume 24 characters.
   *
  ...
  /**
   * Used by subclasses to extract the password and salt from a merged <code>String</code> created
   * using {@link #mergePasswordAndSalt(String, Object, boolean)}. <p> The first element in the
   * returned array is the password. The second element is the salt. The salt array element will
   * always be present, even if no salt was found in the <code>mergedPasswordSalt</code> argument.
   * </p>
   *
  ...
  /**
   * Used by subclasses to generate a merged password and salt <code>String</code>. <P> The
   * generated password will be in the form of <code>password{salt}</code>. </p> <p> A
   * <code>null</code> can be passed to either method, and will be handled correctly. If the
   ...
   * will be used to represent the salt. </p>
   *
